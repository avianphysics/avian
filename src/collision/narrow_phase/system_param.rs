            ...
            if !overlap || !collider1.layers.interacts_with(*collider2.layers) {
                ...
                let (
                    ...
                    .map(|body| {
                        (
                            body.rb.is_static(),
                            (collider1.transform.translation - body.transform.translation).f32(),
                            body.transform.rotation * body.center_of_mass.0,
                ...
                let (
                    ...
                    .map(|body| {
                        (
                            body.rb.is_static(),
                            (collider2.transform.translation - body.transform.translation).f32(),
                            body.transform.rotation * body.center_of_mass.0,
                            body.transform.translation,
                            body.transform.rotation,
                            body.linear_velocity.0,
