...
Previously, `point2` and `normal2` in `ShapeHitData` were also in local space, even though documentation described
them as being in world space. This has been fixed, and they are now in world space like the other values.
